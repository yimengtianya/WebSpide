 ...
 * @version V1.0
 */
public class Cliebiao extends SpideEntryBase {
	...
	protected HashSet<?> setLinks(HtmlPage page, int pageNum) {
		HashSet<String> urlsList = linksStrings(page, "http://\\w+\\.liebiao\\.com/ershoufang/\\d+\\.html");
	...
	protected void parsePage(HtmlPage Mainpage, Object linkItem, int pageNum) {
		...
		html = html.replaceAll(".*免费发布信息", " ");
		html = html.replaceAll("小贴士.*", " ");
		//
